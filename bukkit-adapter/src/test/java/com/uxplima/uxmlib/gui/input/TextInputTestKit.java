...
public final class TextInputTestKit {
    ...
    private static Installed build(Plugin plugin, GuiText guiText, Scheduler scheduler, Path inputDir, Logger log) {
        ...
        InputSettings settings = new InputSettings(inputDir.resolve("text-input.conf"), EngineLog.of(log));
        ...
        TextInput textInput = new TextInput(
                settings, guiText, EngineScheduler.of(scheduler), anvilBackend, chatBackend, EngineLog.of(log));
