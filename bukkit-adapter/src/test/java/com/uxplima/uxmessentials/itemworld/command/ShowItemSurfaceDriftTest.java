...
/**
 * Pins {@code /showitem} into the itemworld context's command surface. zEssentials ships a chat-module
 * {@code /showitem} that broadcasts the held item's name to chat so other players can read what someone is
