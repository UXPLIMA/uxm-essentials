 ...
 * {@code /worth} — it converts held items into currency at their configured worth — and appears in the
 * EssentialsX literal set; this guard fails if the literal drops out of the surface or wires under a node
