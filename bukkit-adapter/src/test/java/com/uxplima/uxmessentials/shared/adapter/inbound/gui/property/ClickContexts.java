...
/**
 * Test helper that builds a {@link PropertyClick} for the apply seams a property exposes for unit testing
...
public final class ClickContexts {
    ...
    public static PropertyClick carrier(Player viewer) {
        return new PropertyClick(
                viewer, false, false, () -> {}, (v, title, rows, filler, buttons) -> {}, (v, title, onYes, onNo) -> {});
    }
}
