...
class JailGuiFlowTest {
    ...
    void setUp() {
        ...
        actorRef = BukkitRefs.toRef(actor);
        ...
        // The picker, duration and jail-chooser screens all run on the menu engine now, so the engine listener routes
        // every click in the flow; uxmLib is still installed for the duration-step confirm and any leftover leaf.
        Guis.install(plugin);
