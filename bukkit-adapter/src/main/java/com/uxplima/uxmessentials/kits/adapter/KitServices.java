...
public record KitServices(
    ...
    /** Backward-compatible 16-parameter constructor for intermediate codebase wiring. */
    public KitServices(
            ClaimKit claimKit,
            ListKits listKits,
            ShowKit showKit,
        ...
        this(
                ...
                kitManagerView,
                players,
                kitCategoryManagerView,
                kitCategorySettingsView,
                kitCategorySelectorView,
                kitCategoryParentSelectorView,
                null);
    }

    /** Backward-compatible 12-parameter constructor for existing codebase wiring. */
    public KitServices(
            ClaimKit claimKit,
            ListKits listKits,
            ShowKit showKit,
    ...
    /** Backward-compatible 11-parameter constructor for test classes. */
    public KitServices(
            ClaimKit claimKit,
            ListKits listKits,
            ShowKit showKit,
