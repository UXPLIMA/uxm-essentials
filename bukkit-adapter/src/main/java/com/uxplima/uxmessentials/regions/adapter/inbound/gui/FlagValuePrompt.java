 ...
 * com.uxplima.uxmlib.gui.input.TextInput} seam ({@code textInput::prompt}); a test wires a
...
public interface FlagValuePrompt {
    ...
    void prompt(Player player, InputRequest request, Consumer<String> onSubmit, Runnable onCancel);
}
