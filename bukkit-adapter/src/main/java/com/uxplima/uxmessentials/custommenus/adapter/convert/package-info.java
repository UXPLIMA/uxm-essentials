 ...
 * migrating off that plugin keeps their menus. Two are shipped so far, each a pure Configurate-only
 ...
 * {@code /menu convert deluxemenus <path>}, and
 ...
 * {@code /menu convert zmenu <path>}. The two services share their path resolution and directory walk through the
