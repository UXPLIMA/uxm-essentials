 ...
 *
 * <p>Bare {@code /tempban} (no arguments) opens the player-picker → duration-picker → confirm GUI flow when the
    ...
    public Optional<Command<CommandSourceStack>> guiRoot() {
        ...
        return Optional.of(ctx -> {
            if (ctx.getSource().getSender() instanceof Player sender) {
                guiFlow.open(sender, BukkitRefs.toRef(sender), PunishmentAction.TEMPBAN);
            }
