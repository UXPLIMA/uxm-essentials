 ...
 * editors do not cover. A move-here button is the motivating case: it reads the operator's current position (a
 * live {@link Player} read that must happen on the region thread) and re-anchors the NPC there, which is not a
 ...
 */
final class NpcActionButton implements EditableProperty {
