 ...
 * com.uxplima.uxmessentials.shared.adapter.inbound.gui.menu.binding.MenuBindings} façade. The four registries
 * here hold those handlers by id and let the engine resolve a ref at render or click time, while {@code validate}
