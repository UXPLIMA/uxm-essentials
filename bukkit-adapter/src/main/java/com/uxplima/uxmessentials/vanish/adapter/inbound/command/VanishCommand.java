 ...
 * confirmation; {@link ListVanished} owns the see-level-scoped roster. This handler only maps players and renders the
 * actor-facing lines.
 */
@NullMarked
public final class VanishCommand implements CommandRegistration {
    ...
    public VanishCommand(ToggleVanish toggleVanish, ListVanished listVanished, Server server, Messages messages) {
