 ...
 * gates (toggle, block, self), so toggled-off and blocking players are silently skipped — the command is
 * a fan-out over the single-target use case, never a privileged bypass.
 */
@NullMarked
