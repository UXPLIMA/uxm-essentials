/**
 * The cross-server bus's Redis transport, shipped as the standalone {@code uxmEssentials-redis} companion jar
 * (docs/09-deployment.md). {@link com.uxplima.uxmessentials.redis.RedisBusTransportAdapter} implements the core
 * {@code BusTransport} SPI on top of uxmlib's Lettuce-backed {@code RedisBus}, carrying the full
 ...
 * configuration so the host {@code bukkit-adapter} references only this factory plus pure-Java port types and
 * never names a Lettuce symbol.
 *
