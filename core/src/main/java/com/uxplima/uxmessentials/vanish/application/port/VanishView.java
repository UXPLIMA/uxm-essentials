...
/**
 * Outbound port that applies a player's vanish state to the live server view: hiding a newly-vanished player from
 * everyone who lacks the vanish-see node, and revealing them again on unvanish. The adapter prefers packet-level
 * hiding (drop the player entity + tablist entry for each ineligible viewer), falling back to Bukkit's
 ...
 * <em>who</em> is vanished; this port is only the visible effect of that state.
 */
