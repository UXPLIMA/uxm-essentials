...
/**
 * {@code /vanish}: flip a player's vanish state through the single {@link VanishStore} authority. Vanishing marks the
 * player in the store and hides them across every viewer who lacks the vanish-see node through the {@link VanishView};
 * unvanishing drops them from the store and reveals them again. The actor is told their new state.
 *
...
public final class ToggleVanish {
    ...
    public ToggleVanish(VanishStore store, VanishView view, VanishNotifier notifier) {
    ...
    public boolean toggle(PlayerRef who) {
        ...
        store.vanish(who.uuid(), VanishLevel.DEFAULT);
        view.hide(who);
