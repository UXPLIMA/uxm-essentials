...
/**
 * Pairs the {@link Messages} resolution port with the {@link MessageSink} delivery port so a player-warp use
 ...
 * homes and warps notifiers rather than sharing one, keeping each context's send surface its own.
 */
public final class PlayerWarpNotifier {

    private final Messages messages;
    private final MessageSink sink;

    public PlayerWarpNotifier(Messages messages, MessageSink sink) {
