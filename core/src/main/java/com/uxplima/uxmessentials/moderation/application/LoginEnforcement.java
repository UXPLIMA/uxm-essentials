 ...
 * player data loads (docs/09-deployment.md). For the connecting UUID/IP it checks, in order: an active
 * per-UUID tempban, then an active IP ban on the connecting address. Either match is a kick-before-data-load.
...
public final class LoginEnforcement {
    ...
    public Decision evaluate(PlayerRef who, String ip) {
