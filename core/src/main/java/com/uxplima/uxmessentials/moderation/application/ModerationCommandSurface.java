 ...
 * {@code /warns} and {@code /unwarn} share the warn node, {@code /jails} shares the jail node, {@code /tempbanip}
 * and {@code /unbanip} share the banip node, and {@code /unfreeze} shares the freeze node — matching the node
 * table.
 */
