...
/**
 * A stored jail location was removed — {@code /deljail <name>} deleted the DB-backed jail {@code jail}. Only a
 * stored jail can be removed this way; a config-defined jail name is not in the store, so a {@code /deljail} of
