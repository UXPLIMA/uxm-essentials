 ...
 * the {@code common.*} cross-cutting notices owned by no single context (the update-available join notice).
 * They sit in {@code shared} so any context references them without a cross-context dependency, exactly as a
 ...
 * {@code lang.*} / {@code common.*} namespaces are owned here.
 */
