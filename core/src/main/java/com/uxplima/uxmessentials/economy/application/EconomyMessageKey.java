...
public enum EconomyMessageKey implements MessageKey {
    ...
    PAY_CONFIRM_GUI_CONFIRM_LORE_HINT("pay.confirm-gui-confirm-lore-hint"),
    PAY_CONFIRM_GUI_CONFIRM_LORE_TARGET("pay.confirm-gui-confirm-lore-target"),
    PAY_CONFIRM_GUI_CONFIRM_LORE_AMOUNT("pay.confirm-gui-confirm-lore-amount"),
    ...
    ECO_ADMIN_MIGRATE_STARTED("eco.admin.migrate-started"),
    ECO_ADMIN_MIGRATE_SUCCESS("eco.admin.migrate-success"),
    ECO_ADMIN_MIGRATE_FAILED("eco.admin.migrate-failed"),
    ...
    LOAN_GUI_REQUEST_HINT("loan.gui-request-hint"),
    ...
    BANK_LIST_GUI_ICON_BALANCE("bank.list-gui-icon-balance"),
    ...
    BANK_ACTIONS_GUI_DEPOSIT_HINT("bank.actions-gui-deposit-hint"),
    ...
    BANK_MEMBERS_GUI_MEMBER_ROLE("bank.members-gui-member-role"),
    BANK_MEMBERS_GUI_MEMBER_REMOVE_HINT("bank.members-gui-member-remove-hint"),
    ...
    HISTORY_GUI_LORE_ID("eco.history.gui-lore-id"),
    HISTORY_GUI_LORE_DATE("eco.history.gui-lore-date"),
    HISTORY_GUI_LORE_FROM("eco.history.gui-lore-from"),
    HISTORY_GUI_LORE_TO("eco.history.gui-lore-to"),
    HISTORY_GUI_LORE_AMOUNT("eco.history.gui-lore-amount"),
    HISTORY_GUI_LORE_REASON("eco.history.gui-lore-reason"),
