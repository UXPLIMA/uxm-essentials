 ...
 * FancyHolograms {@code center} convenience. Save the new snapshot and re-render the live entity. A name no
...
public final class CenterHologram {
    ...
    public CenterHologram(HologramRepository repository, HologramView view, HologramNotifier notifier) {
