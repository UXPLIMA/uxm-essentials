...
/**
 * Pairs the {@link Messages} resolution port with the {@link MessageSink} delivery port so a hologram use
 ...
 * warps and vaults notifiers rather than sharing one, keeping each context's send surface its own.
 */
public final class HologramNotifier {

    private final Messages messages;
    private final MessageSink sink;

    public HologramNotifier(Messages messages, MessageSink sink) {
