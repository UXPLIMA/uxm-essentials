 ...
 * {@code ReturnedFromAfk}, {@code VanishToggled}), never an imperative command. An AFK transition fires whether
 * it was the player's own {@code /afk} or the idle sweep that flipped them; the {@code automatic} flag on
 * {@link WentAfk} distinguishes the two for placeholders and audit lines.
 */
public sealed interface PresenceEvent extends DomainEvent permits WentAfk, ReturnedFromAfk, VanishToggled {}
