...
public enum KitsMessageKey implements MessageKey {
    ...
    KIT_EDITOR_KIT_LORE_COOLDOWN("kit.editor.kit-lore.cooldown"),
    KIT_EDITOR_KIT_LORE_COST("kit.editor.kit-lore.cost"),
    KIT_EDITOR_KIT_LORE_PERMISSION("kit.editor.kit-lore.permission"),
    KIT_EDITOR_KIT_LORE_ONETIME("kit.editor.kit-lore.one-time"),
    KIT_EDITOR_KIT_LORE_EDIT_HINT("kit.editor.kit-lore.edit-hint"),
    ...
    KIT_EDITOR_SETTINGS_PERMISSION_TOGGLE("kit.editor.settings.permission.toggle"),
    ...
    KIT_EDITOR_SETTINGS_ONETIME_TOGGLE("kit.editor.settings.onetime.toggle"),
    ...
    KIT_EDITOR_SETTINGS_COOLDOWN_PROMPT("kit.editor.settings.cooldown.prompt"),
    KIT_EDITOR_SETTINGS_COST_NAME("kit.editor.settings.cost.name"),
    KIT_EDITOR_SETTINGS_COST_LORE("kit.editor.settings.cost.lore"),
    KIT_EDITOR_SETTINGS_COST_PROMPT("kit.editor.settings.cost.prompt"),
    ...
    KIT_EDITOR_SETTINGS_DISPLAY_NAME_PROMPT("kit.editor.settings.display-name.prompt"),
    ...
    KIT_EDITOR_SETTINGS_DISPLAY_MATERIAL_PROMPT("kit.editor.settings.display-material.prompt"),
    ...
    KIT_EDITOR_SETTINGS_DISPLAY_LORE_PROMPT("kit.editor.settings.display-lore.prompt"),
    ...
    KIT_EDITOR_SETTINGS_COMMANDS_PROMPT("kit.editor.settings.commands.prompt"),
    ...
    KIT_EDITOR_SETTINGS_DELETE_WARNING("kit.editor.settings.delete.warning"),
    ...
    KIT_EDITOR_SETTINGS_FIRSTJOIN_TOGGLE("kit.editor.settings.firstjoin.toggle"),
    ...
    KIT_EDITOR_SETTINGS_AUTOEQUIP_TOGGLE("kit.editor.settings.autoequip.toggle"),
    KIT_EDITOR_KIT_LORE_FIRSTJOIN("kit.editor.kit-lore.first-join"),
    KIT_EDITOR_KIT_LORE_AUTOEQUIP("kit.editor.kit-lore.auto-equip"),
    ...
    KIT_EDITOR_CATEGORY_SETTINGS_DISPLAY_MATERIAL_PROMPT("kit.editor.category.settings.display-material.prompt"),
    ...
    KIT_EDITOR_CATEGORY_SETTINGS_DELETE_WARNING("kit.editor.category.settings.delete.warning"),
    ...
    KIT_EDITOR_CATEGORY_SETTINGS_DISPLAY_NAME_CURRENT("kit.editor.category.settings.display-name.current"),
    KIT_EDITOR_CATEGORY_SETTINGS_DISPLAY_MATERIAL_CURRENT("kit.editor.category.settings.display-material.current"),
    KIT_EDITOR_CATEGORY_SETTINGS_DISPLAY_LORE_CURRENT("kit.editor.category.settings.display-lore.current"),
    KIT_EDITOR_CATEGORY_SETTINGS_SLOT_CURRENT("kit.editor.category.settings.slot.current"),
    KIT_EDITOR_CATEGORY_SETTINGS_PARENT_CURRENT("kit.editor.category.settings.parent.current"),
    KIT_EDITOR_CATEGORY_SETTINGS_PARENT_PROMPT("kit.editor.category.settings.parent.prompt"),

    // manager hints
    KIT_EDITOR_SETTINGS_CATEGORY_PROMPT("kit.editor.settings.category.prompt"),
