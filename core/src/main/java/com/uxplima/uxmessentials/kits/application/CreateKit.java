 ...
 * kit and persisted back to {@code kits.conf}; an id a kit already exists under is refused with
...
public final class CreateKit {
    ...
    public CreateKit(KitRepository repository, KitNotifier notifier) {
