/**
 * The kits context's outbound ports: {@code KitRepository} for the config-backed kit catalog
 * ({@code kits.conf}), {@code KitClaimStore} for the per-player one-time-claim stamp (PDC), {@code KitGranter}
