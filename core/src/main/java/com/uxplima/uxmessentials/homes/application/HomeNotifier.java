...
/**
 * Pairs the {@link Messages} resolution port with the {@link MessageSink} delivery port so a home use
 ...
 * teleport context's notifier rather than sharing one, keeping each context's send surface its own.
 */
public final class HomeNotifier {

    private final Messages messages;
    private final MessageSink sink;

    public HomeNotifier(Messages messages, MessageSink sink) {
