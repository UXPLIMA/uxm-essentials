 ...
 * new spot. A name no NPC exists at is rejected with {@link NpcError#NOT_FOUND}. The operator-only permission is
...
public final class MoveNpcTo {
    ...
    public MoveNpcTo(NpcRepository repository, NpcView view, NpcNotifier notifier) {
