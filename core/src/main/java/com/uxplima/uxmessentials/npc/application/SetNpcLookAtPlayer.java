 ...
 * The operator-only permission is enforced at the adapter gate; this use case owns the not-found decision and the
 * persistence.
 */
public final class SetNpcLookAtPlayer {
    ...
    public SetNpcLookAtPlayer(NpcRepository repository, NpcView view, NpcNotifier notifier) {
