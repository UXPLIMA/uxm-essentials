...
/**
 * A player warp is about to be created. Cancel to refuse it.
 *
 ...
 */
@NullMarked
public final class UxmPlayerWarpPreCreateEvent extends UxmPlayerCancellableEvent {
    ...
    public UxmPlayerWarpPreCreateEvent(UUID ownerId, String ownerName, String warpName, UxmLocation location) {
